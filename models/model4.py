...
def build_model(input_shape=(4, 160, 192, 128), output_channels=cfg['classes'], weight_L2=0.1, weight_KL=0.1, dice_e=1e-8):
    """
    ...
    model.compile(
        ...
        loss=[loss_gt(dice_e), loss_VAE(input_shape, z_mean, z_var, weight_L2=weight_L2, weight_KL=weight_KL)],
